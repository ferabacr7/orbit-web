...
const cardLayouts: CardLayout[] = [
  { shape: "left", height: 360, offset: 10 }, // Handyman
  { shape: "left", height: 370, offset: 0 }, // Restaurants
  { shape: "left", height: 360, offset: 8 }, // Pools

  { shape: "right", height: 352, offset: 14 }, // Mechanics
  { shape: "right", height: 368, offset: 4 }, // Pharmacies

  { shape: "left", height: 358, offset: 10 }, // Pet Care
  { shape: "left", height: 364, offset: 6 }, // Delivery

  { shape: "right", height: 354, offset: 14 }, // Tours
  { shape: "right", height: 364, offset: 6 }, // A/C

  { shape: "left", height: 358, offset: 10 }, // Barbers
];
...
export function ServiceCard({ category, name, index }: ServiceCardProps) {
  ...
  return (
    ...
    >
      ...
      <article
        className="relative w-[150px] overflow-hidden bg-black"
        style={{
